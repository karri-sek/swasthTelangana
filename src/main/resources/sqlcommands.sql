...
DROP TABLE T_MTP_PATIENT;

CREATE TABLE T_MTP_PATIENT
( 
  F_PATIENT_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
  F_PATIENT_NAME VARCHAR(100),
  F_CREATED_TIMESTAMP DATETIME,
...
DROP TABLE T_MTP_PATIENT_ADDRESS;

CREATE TABLE T_MTP_PATIENT_ADDRESS
(
	F_PATIENT_ID      BIGINT PRIMARY KEY,
	F_DISTRICT        VARCHAR(50),
	F_STATE           VARCHAR(40),
...
DROP TABLE T_MTP_PATIENT_CURRENT_ADDRESS;

CREATE
  TABLE T_MTP_PATIENT_CURRENT_ADDRESS
  (
    F_PATIENT_ID BIGINT PRIMARY KEY,
    F_DISTRICT_CURRENT VARCHAR(50),
    F_STATE_CURRENT    VARCHAR(40),
...
DROP TABLE T_MTP_CLINIC_DETAILS;

CREATE TABLE T_MTP_CLINIC_DETAILS
(   
  F_CLINIC_OWNER_NAME VARCHAR(100),
  F_TYPE     VARCHAR(500),
  F_REG_NO  VARCHAR(50),
...
DROP TABLE T_MTP_OTHER_DETAILS;	
	
CREATE
  TABLE T_MTP_OTHER_DETAILS
  (
	F_PATIENT_ID BIGINT PRIMARY KEY,
	F_WEEKS_OF_PREGNANCY     INT,
	F_IS_MENTALLY_ILL        VARCHAR(10),
	F_IS_A_MINOR             VARCHAR(10),
	F_IS_A_MARRIED           VARCHAR(10),
	F_IS_FATHER              VARCHAR(10),
	F_DAUGHTER_OF_WIFE_OF    VARCHAR(50),
	F_GUARDIAN_NAME          VARCHAR(50),
	F_REASON_FOR_TERMINATION VARCHAR(500)
  );
...
DROP TABLE T_BR_LEGAL_INFO;

CREATE
  TABLE T_BR_LEGAL_INFO
  (
    F_BR_ID BIGINT AUTO_INCREMENT PRIMARY KEY,
    F_DATE_OF_BIRTH  DATE,
    F_SEX            VARCHAR(10),
    F_CHILD_NAME     VARCHAR(100),
    F_FATHER_NAME    VARCHAR(100),
    F_MOTHER_NAME    VARCHAR(100),
    F_PLACE_OF_BIRTH VARCHAR(50),
    F_CONTACT_NO BIGINT,
    F_HOSPITAL_NAME VARCHAR(100),
    F_MOTHER_AADHAR_N0 BIGINT,
    F_INFORMANTS_NAME    VARCHAR(50),
    F_INFORMANTS_ADDRESS VARCHAR(500),
    F_CREATED_BY         VARCHAR(100),
    F_CREATED_TIMESTAMP  DATETIME,
    F_UPDATED_TIMESTAMP  DATE
  );
	
DROP TABLE T_BR_BIRTH_ADDRESS;  
  
CREATE
  TABLE T_BR_BIRTH_ADDRESS
  (
    F_BR_ID BIGINT PRIMARY KEY,
    F_ADDRESS  VARCHAR(1000),
    F_CITY     VARCHAR(50),
    F_DISTRICT VARCHAR(50),
    F_STATE    VARCHAR(40),
...
DROP TABLE T_BR_PERMANENT_ADDRESS;   
  
CREATE
  TABLE T_BR_PERMANENT_ADDRESS
  (
    F_BR_ID BIGINT PRIMARY KEY,
    F_IS_VILLAGE_TOWN_CITY VARCHAR(20),
    F_ADDRESS_PERMANENT    VARCHAR(1000),
    F_CITY_PERMANENT       VARCHAR(50),
    F_DISTRICT_PERMANENT   VARCHAR(50),
    F_STATE_PERMANENT      VARCHAR(40),
    F_PINCODE_PERMANENT BIGINT
  );

DROP TABLE T_BR_STATS_FAMILY_INFO;   
  
CREATE
  TABLE T_BR_STATS_FAMILY_INFO
  (
    F_BR_ID BIGINT PRIMARY KEY,
    F_RELIGION          VARCHAR(20),
    F_FATHER_EDUCATION  VARCHAR(50),
    F_MOTHER_EDUCATION  VARCHAR(50),
    F_FATHER_OCCUPATION VARCHAR(50),
    F_MOTHER_OCCUPATION VARCHAR(50),
    F_MOTHER_AGE DOUBLE,
    F_MOTHER_AGE_AT_MRG INT,
    F_NO_OF_CHILDREN    INT
  );

DROP TABLE T_BR_STATS_HEALTH_INFO; 	
	
CREATE
  TABLE T_BR_STATS_HEALTH_INFO
  (
    F_BR_ID BIGINT PRIMARY KEY,
    F_ATTENTION_AT_DELIVERY VARCHAR(100),
    F_DELIVERY_METHOD       VARCHAR(50),
    F_BIRTH_WEIGHT DOUBLE,
    F_PRAGNANCY_DURATION INT
  );  
...
DROP TABLE T_USER_CLINIC_DETAILS;
  
CREATE
  TABLE T_USER_CLINIC_DETAILS
  (
    F_LOGIN_ID VARCHAR(20) NOT NULL PRIMARY KEY,
    F_CLINIC_OWNER_NAME VARCHAR(100),
	F_TYPE     VARCHAR(500),
