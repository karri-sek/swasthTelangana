<div id="patientSearchReport" class="panel panel-default">
    <div class="panel-heading">Get Birth report details with mother aadhaar number</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-lg-3">
                        <a class="btn btn-primary form-control" href="#"
                           onclick="submitForm('/account/searchBirthReportDetails.action', 'searchPatientAadhar', 'searchResultdiv');">
                            Search </a>
                    </div>
                </div>
            </form>
