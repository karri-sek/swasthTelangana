	...
	<div class="row">
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-aqua">
				...
				<a href="#"
						onclick="submitForm('/account/formFDashboardDetails.action', 'NO-DATA', 'dashboardContainer');" class="small-box-footer">More info <i
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-yellow">
				...
				<a href="#"  onclick="submitForm('/account/mtpDashboardDetails.action', 'NO-DATA', 'dashboardContainer');" class="small-box-footer">More info <i
					class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-green">
				...
				<a href="#" onclick="submitForm('/account/birtReporthDashboardDetails.action', 'NO-DATA', 'dashboardContainer');" class="small-box-footer">More info <i
					class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<!-- ./col -->
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-red">
				...
				<a href="#" onclick="submitForm('/account/orphanFormFDashboardDetails.action', 'NO-DATA', 'dashboardContainer');" class="small-box-footer">More info <i
					class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<!-- ./col -->
  ...
  var yearChartData = {
		    ...
		    datasets: [
		      ...
		      },
		      {
		          ...
		          pointHighlightFill: "#fff",
		          pointHighlightStroke: "rgba(60,141,188,1)",
		          data: [180000, 280000, 400000, 140000, 160000, 270000, 150000]
		        }
		    ]
		  };
  ...
  var districtData = {
		    ...
		    datasets: [
		      ...
		      },
		      {
		        ...
		        pointHighlightFill: "#fff",
		        pointHighlightStroke: "rgba(60,141,188,1)",
		        data: [2800, 8800, 4000, 1900, 4600, 2700, 2200, 3800, 6800, 8000]
		      },
		      {
		          label: "MTP",
		          fillColor: "rgba(40,101,138,0.8)",
		          ...
		          pointHighlightFill: "#fff",
		          pointHighlightStroke: "rgba(60,141,188,1)",
		          data: [1800, 5800, 3000, 1400, 3600, 2700, 1500, 2800, 1800, 1000]
		        }
		    ]
		  };
