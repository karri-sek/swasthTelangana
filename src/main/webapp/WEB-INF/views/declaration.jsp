...
<div class="box box-info">
	<div class="box-header with-border">
		<h3 class="box-title">DECLARATION OF DOCTOR/PERSON CONDUCTING PRE
			NATAL DIAGNOSTIC PROCEDURE/TEST</h3>
	</div>
	<!-- /.box-header -->
	<!-- form start -->
		...
		<c:choose>
			...
			<c:otherwise>
				<div class="box-body">
					...
					detected nor disclosed the sex of her fetus to anybody in any
					manner. Date:
