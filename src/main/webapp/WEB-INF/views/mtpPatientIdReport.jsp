<div id="patientSearchReport" class="panel panel-default">
    <div class="panel-heading">Get MTP Patient Details with Patient ID</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-lg-3">
                        <a class="btn btn-primary form-control" href="#"
                           onclick="submitForm('/account/mtpPatientSearchReport.action', 'searchPatientId', 'searchResultdiv');">
                            Search </a>
                    </div>
                </div>
            </form>
