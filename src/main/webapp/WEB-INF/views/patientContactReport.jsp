<div class="panel panel-default">
    <div class="panel-heading">Get Patient Details with Patient Contact number</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3 col-lg-3">
                        <a class="btn btn-primary form-control" href="#"
                           onclick="submitForm('/account/patientSearchReport.action', 'searchPatientContact', 'searchResultdiv');">
                            Search </a>
                    </div>
                </div>
            </form>
