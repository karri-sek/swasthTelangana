...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Centre address</h3>
    </div>
    ...
    <form class="form-horizontal" method="POST" name="clinicForm"
        ...
        <div class="form-group mandatory">
            <label class="control-label col-sm-2"> Centre Name</label>

            <div class="col-sm-5">
                <input class='form-control required' placeholder="Centre Name ..." name="clinicName" type='text' value="${clinicAddress.clinicName}"/>
            </div>
        </div>
        <div class="form-group mandatory">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2">Centre contact no.</label>

            <div class="col-sm-5">
                <input class='form-control onlyNumber' placeholder="Enter Centre contact No" name="contactNum"
                       type='text' value="${clinicAddress.contactNum}"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2">Centre Address</label>
        ...
        <div class="box-footer">
				...
				<div class="col-sm-3">
					<a class="btn btn-default col-sm-5" href="#"
						onclick="submitForm('/account/previousRegCentreAddress.action', 'clinicFormPrevious', 'containerdiv');">Previous</a>
				</div>
				<div class="col-sm-3">
					<a class="btn btn-primary" href="#"
						onclick="submitForm('/account/saveRegCentreAddress.action', 'clinicForm', 'containerdiv');">Save</a>
				</div>
				<div class="col-sm-3">
					<a class="btn btn-primary" href="#"
						onclick="submitForm('/account/nextRegCentreAddress.action', 'clinicForm', 'containerdiv');">Next</a>
				</div>
			</div>
