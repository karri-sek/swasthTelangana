	...
	$(function() {
		...
		var districtData = {
			...
			datasets : [ {
				...
				pointHighlightFill : "#fff",
				pointHighlightStroke : "rgba(220,220,220,1)",
				data: [6900, 9900, 5000, 4100, 5600, 5500, 2000, 7500, 4900, 8000]
			}, {
				...
				pointHighlightFill : "#fff",
				pointHighlightStroke : "rgba(60,141,188,1)",
				data: [6500, 9600, 4600, 3200, 5600, 5000, 2200, 7100, 4850, 8200]
			} ]
		};
		...
		lineChart.Line(avgPregnancyData, lineChartOptions);
